 ...
 * @param {String} _str - The string value for the new token. Defaults to an empty string if not provided.
 * @param {Number} _flag - The flag value for the new token. Defaults to 0 if not provided.
 ...
 */
export const fast_token_fact = (_str = ``, _flag = 0, loc = new location()) => {
    let ret = new token();
    ret.str = _str;
    ret.flag = _flag;
    ret.loc = loc;
